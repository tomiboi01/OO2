...
public abstract class SingleThreadTCPServerRefactorizado {
    ...
    private final void handleClient(Socket clientSocket) {
        ...
        try (
            ...
            while ((inputLine = in.readLine()) != null) {
                ...
                if (isEndOfCommunicationWord(inputLine)) {
    ...
    private boolean isEndOfCommunicationWord(String inputLine) {
        return inputLine.equalsIgnoreCase("");
    }

    private void afterCommunication(Socket clientSocket) {
